...
process.source = cms.Source("PoolSource", 
    fileNames = cms.untracked.vstring([
            '/store/data/Run2015D/SingleElectron/MINIAOD/PromptReco-v4/000/258/159/00000/0EC56452-186C-E511-8158-02163E0146D5.root'#        '/store/data/Run2015D/DoubleMuon/MINIAOD/05Oct2015-v1/30000/B0E177F6-8A6F-E511-A81F-0025905B85D6.root'
    ])
)
...
process.selectedObjects = cms.EDProducer("PFCleanerPurity",
...
# Make the tree 
process.tree = cms.EDAnalyzer("MonoJetTreeMakerPurity",
    rho=cms.InputTag("fixedGridRhoFastjetAll"),
    ...
    photonsLivia = cms.InputTag("selectedObjects", "photonsLivia"),
    tightphotonsLivia = cms.InputTag("selectedObjects", "tightphotonsLivia"),
